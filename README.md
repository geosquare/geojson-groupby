# geojson-groupby
Group GeoJSON features or array of JOSN based on associated properties.
## installation
...
## usage
```javascript
var groupBy = require('geojson-groupby');
var group = groupBy(features, property [,property, ...]);
```
The function accepts multiple number of properties.
* **features**  Array of geojson features or JSON objects
* **property**  JSON/GeoJSON properties' path or lookup object
