...
describe('groupBy: ', function() {
  ...
  it('features are not modified', function() {
    var features = [
      {id: 1, geometry: {type: 'Point', coordinates: [1,2]}, properties: {
         gender: 'Female', price: 11000}},
      {id: 1, geometry: {type: 'Point', coordinates: [11,12]}, properties: {
         gender: 'Male', price: 10000}}
    ];
    var group = groupBy(features, 'properties.gender');
    expect(group['Female'][0]).to.deep.equal(
      {id: 1, geometry: {type: 'Point', coordinates: [1,2]}, properties: {
         gender: 'Female', price: 11000}}
    );
    expect(group['Male'][0]).to.deep.equal(
      {id: 1, geometry: {type: 'Point', coordinates: [11,12]}, properties: {
         gender: 'Male', price: 10000}}
    );
  });
